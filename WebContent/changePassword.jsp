...
<body>
	...
	<a href="#"
		...
		class="fa fa-users fa-fw"></i>  Applied Jobs</a> <a href="#"
		class="w3-padding "><i class="fa fa-bullseye fa-fw "></i>
		Ask Query</a> <a href="studentProfile.jsp" class="w3-padding  w3-blue"><i
	...
	<div class="w3-main " style="margin-left: 300px; margin-top: 43px;">
		...
		<div class="w3-container">
			...
			<div class="form-group">
				<label>Old Password<sup style="color: red">*</sup></label> <input
					type="password" class="form-control" id="studentOldPassword"
					onblur="checkOldPassword()" required>
			</div>
			<label id="oldPasswordResult"></label>
			<div class="form-group">
				<label>New Password<sup style="color: red">*</sup></label> <input
					type="password" class="form-control" id="newPassword" required>
			</div>
			<div class="form-group">
				<label>Conform New Password<sup style="color: red">*</sup></label> <input
					type="password" class="form-control" id="conformNewPassword"
					required>
			</div>

			<button type="submit" class="btn btn-success btn-block"
				onclick="changePassword()">Submit</button>
				<label id="changedPassowrdResult"></label>
			<br>
		</div>
		<!-- End page content -->
	</div>
