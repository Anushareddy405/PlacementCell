...
<%
	...
	mResult = (ResultSet) DatabaseConnector.getResultSet("select skill_desc from skills_master;", 1);
	ArrayList<String> skills = new ArrayList<String>();
	while (mResult.next()) {
		skills.add(mResult.getString("skill_desc"));
	}
%>
...
<body>
	...
	<a href="#" class="w3-padding w3-blue"><i class="fa fa-users fa-fw"></i> 
		Add Skills</a> <a href="addStudent.jsp" class="w3-padding"><i
					...
					<tr>
						...
						<td>
							<form action="Skills" method="post">
								<input type="hidden" name="skill_id" value="<%=skills.get(i)%>">
