...
<%
	...
	/* ResultSet mResult = (ResultSet)DatabaseConnector.getResultSet("select * from user where user_id="+user_id+";", 1);
	if(mResult.next()){ */
...
<body>
	...
	<div class="w3-container w3-row">
		...
		<div class="w3-col s8">
			<span>Welcome, <strong><%=userFullName%></strong></span><br> <a
				...
				class="fa fa-envelope"></i></a>  <a href="changePassword.jsp"
	...
	<a href="adminDashboard.jsp" class="w3-padding"><i class="fa fa-users fa-fw"></i> 
