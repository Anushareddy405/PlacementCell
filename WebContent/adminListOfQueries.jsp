...
<%
	...
	mResult = (ResultSet) DatabaseConnector
			.getResultSet("select query_subject from queries where query_to = '1';", 1);
...
<body>
	...
	<div class="w3-container w3-top w3-black w3-large w3-padding"
		style="z-index: 4">
		<span class="w3-left">JNTUH Student Placements Portal</span> <a
			href="Logout" class="w3-right light">Logout</a>
	</div>
