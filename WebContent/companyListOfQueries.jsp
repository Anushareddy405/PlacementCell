...
<%
	...
	mResult = (ResultSet) DatabaseConnector
			.getResultSet("select query_subject from queries where query_to =" + user_id + ";", 1);
	ArrayList<String> querySubject = new ArrayList<String>();
	while (mResult.next()) { 
		querySubject.add(mResult.getString("query_subject"));
	}
...
<body>
	...
	<a href="#"
		...
		class="fa fa-remove fa-fw"></i>  Close Menu</a> <a href="companyDashboard.jsp"
		class="w3-padding"><i class="fa fa-users fa-fw"></i>  Dashboard</a> <a
		href="postJob.jsp" class="w3-padding"><i class="fa fa-eye fa-fw"></i> 
		Post Job</a> <a href="listOfPostedJobs.jsp" class="w3-padding"><i
		class="fa fa-bullseye fa-fw"></i>  Applied Students</a> <a
		href="companyQueryDescription.jsp" class="w3-padding  w3-blue"><i
