...
<%
	...
	mResult = (ResultSet) DatabaseConnector.getResultSet("SELECT COUNT(*) FROM post_job_td where isActive = 0;",
			1);
	if (mResult.next()) {
		activeJobsCount = mResult.getString("COUNT(*)");
	}
	...
	mResult = (ResultSet) DatabaseConnector
			.getResultSet("SELECT COUNT(*) FROM applied_job where user_id = " + user_id + ";", 1);
	if (mResult.next()) {
	...
	String jobsThisWeekCount = "";
	mResult = (ResultSet) DatabaseConnector.getResultSet(
			"select COUNT(*) from post_job_td where event_date between CURDATE() and  DATE_ADD(CURDATE(),INTERVAL 6 DAY);",
			1);
	if (mResult.next()) {
		jobsThisWeekCount = mResult.getString("COUNT(*)");
	}
	...
	<div class="w3-main" style="margin-left: 300px; margin-top: 43px;">
		...
		<div class="w3-row-padding w3-margin-bottom">
			...
			<div class="w3-quarter">
				<div class="w3-container w3-teal w3-padding-16">
					...
					<div class="w3-right">
						<h3><%=jobsThisWeekCount%></h3>
					</div>
					<div class="w3-clear"></div>
					<h4>Jobs this Weak</h4>
				</div>
			</div>
		</div>
		<hr>
		<div class="w3-container w3-section ">
			<div class="w3-row-padding" >
				<h5>Applied Jobs</h5>
				<div class="w3-twothird " style="height: 180px; overflow-x: scroll;">
					<table class="table">
						<tbody>
							<%
