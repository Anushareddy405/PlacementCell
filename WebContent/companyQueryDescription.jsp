...
<%
	...
	System.out.println("this is in jsp" + query_desc);
%>
...
<body>
	...
	<a href="#"
		...
		class="fa fa-bullseye fa-fw"></i>  Applied Students</a> <a href="companyListOfQueries.jsp"
		class="w3-padding w3-blue"><i class="fa fa-diamond fa-fw"></i>  Queries</a> <br>
	<br>
	</nav>
